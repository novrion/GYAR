...
void Board::Initialize(const char kFen[80]) {
  ...
  // for (int i = 0; i < 8; ++i) {
  //   for (int j = 7; j > -1; --j) {
  //     if (this->board[j][i] == 0) printf("x");
  //     else printf("%i", this->board[j][i]);
  //   }
  // }
  // printf("\n");
  // //printf("%i%i", this->en_passant_x, this->en_passant_y);
  // if (this->en_passant_x == -1) printf("0");
  // else printf("%i", (7-this->en_passant_y) * 8 + this->en_passant_x);
  // if (this->side) printf("white"); else printf("black");
  // if (this->w_r_castle) printf("1"); else printf("0");
  // if (this->w_l_castle) printf("1"); else printf("0");
  // if (this->b_r_castle) printf("1"); else printf("0");
  // if (this->b_l_castle) printf("1"); else printf("0");
  // printf("\n");
}