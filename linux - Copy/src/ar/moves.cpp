...
inline void WKingMoves(Board& b, Move moves[100], const int kPosX, const int kPosY) {
  ...
  // Castle
//   if (b.w_l_castle && !b.board[1][0] && !b.board[2][0] && !b.board[3][0] && b.board[0][0] == 5000) {
...
//   if (b.w_r_castle && !b.board[5][0] && !b.board[6][0] && b.board[7][0] == 5000) {
...
inline void BKingMoves(Board& b, Move moves[100], const int kPosX, const int kPosY) {
  ...
  // Castle
  // if (b.b_l_castle && !b.board[1][7] && !b.board[2][7] && !b.board[3][7] && b.board[0][7] == -5000) {
  //   AddMove(moves, Move(kPosX, kPosY, kPosX - 2, kPosY, 0, false, false, 0, 3));
  ...
  // if (b.b_r_castle && !b.board[5][7] && !b.board[6][7] && b.board[7][7] == -5000) {
