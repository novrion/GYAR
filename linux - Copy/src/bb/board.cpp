...
void Board::Initialize(const char kFen[80]) {
	...
	// for (int i = 63; i > -1; --i) {
	// 	bool flag = false;
	// 	for (int bor = 1; bor < 13; ++bor) {
	// 		if ((1ULL << i) & this->bb[bor]) {printf("%i", kMaterialScore[bor]); flag = true; }
	// 	}
	// 	if (flag == false) printf("x");
	// }

	// printf("\n");
	// printf("%i", GET_UTILITY_EN_PASSANT(this->bb[0]));
	// if (GET_UTILITY_SIDE(this->bb[0])) printf("white"); else printf("black");
	// if (GET_UTILITY_W_SHORT_CASTLE(this->bb[0])) printf("1"); else printf("0");
	// if (GET_UTILITY_W_LONG_CASTLE(this->bb[0])) printf("1"); else printf("0");
	// if (GET_UTILITY_B_SHORT_CASTLE(this->bb[0])) printf("1"); else printf("0");
	// if (GET_UTILITY_B_LONG_CASTLE(this->bb[0])) printf("1"); else printf("0");
	// printf("\n");
}